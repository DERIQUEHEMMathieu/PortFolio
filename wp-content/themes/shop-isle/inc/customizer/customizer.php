...
function shop_isle_customize_register( $wp_customize ) {
	...
	if ( is_file( get_template_directory() . '/inc/customizer/customizer-scroll/class/class-shopisle-customize-control-scroll.php' ) ) {
		require_once get_template_directory() . '/inc/customizer/customizer-scroll/class/class-shopisle-customize-control-scroll.php';
	}

	if ( class_exists( 'Shop_Isle_Customize_Control_Scroll', false ) ) {
